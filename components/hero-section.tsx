    ...
    <section className="min-h-screen flex items-center justify-center pt-20 px-4">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="animate-fade-in-up">
          <p className="text-sm font-semibold mb-4 tracking-widest uppercase" style={{ color: "#6B5B4A" }}>
          ...
          <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
            I'm a self-taught Full-Stack Developer skilled in building modern, user-friendly web applications using JavaScript, Python, React, Node.js, and MySQL. I integrate AI tools into real-world solutions and I'm currently on a self-learning cybersecurity journey, expanding my skills in system security, networking, and ethical hacking.
          </p>
